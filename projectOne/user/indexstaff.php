...
<body>
    ...
    <div class="row">
        <div class="col-3 content">
            ...
            <h4>Hello..</h4>>
            <ul class="can_links">
                <li><a href="update_profilestaff.php">Update Profile</a></li>
                <li><a href="update_passwordstaff.php">Change Password</a></li>
                <li><a href="#savedNotice" onclick="showSavedNotice()">Saved Notices</a></li>
            </ul>
        </div>
